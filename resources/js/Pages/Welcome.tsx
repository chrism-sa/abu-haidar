                ...
                {appState === "welcome" && (
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            className="absolute right-4 md:right-10 top-1/2 -translate-y-1/2 flex flex-col items-center gap-3 md:gap-4 z-50 p-2.5 md:p-3 rounded-full bg-white/60 backdrop-blur-md border border-white/80 shadow-[0_8px_30px_rgb(0,0,0,0.04)]"
                            ...
                            {socials.map((social) => {
                                ...
                                return (
                                    <a
                                        ...
                                        className={`flex h-10 w-10 md:h-12 md:w-12 items-center justify-center rounded-full bg-white shadow-xs text-[#0F4C3A] transition-all duration-300 ease-out hover:shadow-md hover:text-[#0A382A] ${
                                            isDimmed
                                                ? "opacity-30 scale-95"
                                                : "opacity-100"
                                        } ${isCurrent ? "scale-110 -translate-x-1" : ""}`}
