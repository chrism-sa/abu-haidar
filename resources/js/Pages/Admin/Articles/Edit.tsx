...
export default function ArticleEdit({ article, categories, quote }: EditProps) {
    ...
    const initialQuoteIsYoutube = quote?.image
        ...
        : false;
    const initialQuoteType: "text" | "image" | "youtube" = initialQuoteIsYoutube
        ? "youtube"
        : quote?.image
          ? "image"
          : "text";
    ...
    const {
        ...
        quote_line_height: quote?.line_height || 2.4,
        ...
        const handleImageClick = (e: MouseEvent) => {
            ...
            if (target && target.tagName === "IMG") {
                ...
                const newWidth = prompt(
                    "Masukkan ukuran lebar gambar (contoh: 200px, 50%, atau 100%):",
                    currentWidth,
                );
                if (newWidth !== null) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post(`/admin/articles/${article.id}`, {
            ...
            onError: () => {
                toast.error(
                    "Gagal menyimpan perubahan artikel. Silakan periksa kolom isian.",
                );
            },
        });
    };
    ...
    const quoteYtId =
        quoteType === "youtube"
            ? getYouTubeId(data.quote_youtube_url || quote?.image)
            : null;
    ...
    return (
        <div className="min-h-screen bg-[#F7EAE0] text-[#5E3122] selection:bg-[#1D4533] selection:text-[#F7EAE0] pb-16">
            ...
            {/* HEADER STICKY (Z-50) */}
            <header className="sticky top-0 z-50 w-full border-b border-[#E8CEBC] bg-[#F7EAE0]/95 backdrop-blur-md shadow-xs">
                            ...
                            <div className="mx-auto max-w-[950px] relative rounded-2xl border border-[#E8CEBC] bg-white shadow-xs">
                                ...
                                <div className="p-4 sm:p-6 min-h-[420px]">
                                    <ReactQuill
                                        ...
                                        placeholder="Mulai menulis naskah artikel kajian di sini..."
                                    />
                                </div>
