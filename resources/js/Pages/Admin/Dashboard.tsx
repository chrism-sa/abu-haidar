...
export default function Dashboard({ auth }: DashboardProps) {
    return (
        <div className="min-h-screen bg-[#fafaf8] text-[#17251f]">
            <Head title="Dashboard Admin - Abu Hurairah" />

            {/* Top Navigation Bar khusus Admin */}
            <header className="border-b border-[#e9e6df] bg-white">
                <div className="mx-auto flex max-w-[1140px] items-center justify-between px-5 py-4 lg:px-0">
                    <div className="flex items-center gap-3">
                        <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#063f2f] text-white font-serif font-bold">
                            AH
                        </div>
                        <div>
                            ...
                            <p className="text-[10px] text-[#777]">
                                Kelola Konten Website Abu Hurairah
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        <Link
                            href="/"
                            className="flex items-center gap-1.5 rounded-lg border border-[#dedbd2] px-3 py-2 text-[12px] font-medium text-[#444] transition hover:bg-[#fafaf8]"
                        >
            ...
            <main className="mx-auto max-w-[1140px] px-5 py-10 lg:px-0">
                ...
                <div className="mb-8 rounded-2xl bg-[#063f2f] p-8 text-white shadow-sm">
                    ...
                    <p className="mt-2 text-[13px] text-white/80 max-w-xl leading-relaxed">
                        ...
                        pilihan yang tampil di halaman utama website secara
                        *real-time*.
                    </p>
                </div>
